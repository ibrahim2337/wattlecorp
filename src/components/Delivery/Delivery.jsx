...
const Delivery = () => {
  return (
    <div className="bg-[#D83E27] py-16 lg:px-40 px-5">
      ...
      <div className="grid lg:grid-cols-12 gap-5 pt-10 pb-5">
        <div className="lg:col-span-4 border p-5 bg-[#FDE8E5] hover:bg-white">
          <div>
            <SiFsecure className="h-10 w-10 text-[#D83E27]" />
          </div>
          <h1 className="pt-5 text-lg font-bold text-[#2F2A2A]">
          Detailed Report
          </h1>
          <p className="pt-3 text-sm font-bold text-[#C3B5B3]">
          The report details specific vulnerabilities identified on the platform, how they were identified, methods and tools used to identify them, and visual evidence if applicable. . The report comes with a security vulnerability risk rating
          </p>
        </div>

        <div className="lg:col-span-5 border p-5 bg-[#FDE8E5] hover:bg-white">
          <div>
            <SiFsecure className="h-10 w-10 text-[#D83E27]" />
          </div>
          <h1 className="pt-5 text-lg font-bold text-[#2F2A2A]">
        ...
        <div className="lg:col-span-3 border p-5 bg-[#FDE8E5] hover:bg-white">
          <div>
            <SiFsecure className="h-10 w-10 text-[#D83E27]" />
          </div>
          <h1 className="pt-5 text-lg font-bold text-[#2F2A2A]">
